...
object AnalyticsReporter {
    ...
    fun install(
        ...
        analytics = client
        runCatching {
            client.setAnalyticsCollectionEnabled(enabled && !com.nastechresearch.andcode.BuildConfig.DEBUG)
        }
    }

    fun setEnabled(enabled: Boolean) {
        runCatching { analytics?.setAnalyticsCollectionEnabled(enabled && !com.nastechresearch.andcode.BuildConfig.DEBUG) }
    }
