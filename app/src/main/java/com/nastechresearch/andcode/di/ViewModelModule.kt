    ...
    module {
        ...
        viewModel {
            ...
            ChatViewModel(
                ...
                videoNotSupportedMessage = androidContext().getString(com.nastechresearch.andcode.R.string.error_video_not_supported),
            )
        }
        ...
        viewModel {
            WorkspaceViewModel(
                ...
                incompleteConnectionMessage = androidContext().getString(com.nastechresearch.andcode.R.string.connection_info_incomplete),
            )
        }
        ...
        viewModel {
            SettingsViewModel(
                ...
                providerDisconnectRejectedMessage =
                    androidContext().getString(com.nastechresearch.andcode.R.string.provider_disconnect_rejected),
                customProviderInvalidMessage =
                    androidContext().getString(com.nastechresearch.andcode.R.string.provider_custom_invalid),
            )
        }
