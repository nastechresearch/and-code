...
interface RuntimeConnectionStore {
    ...
    fun connections(): List<com.nastechresearch.andcode.data.connection.ConnectionProfile>

    fun upsertConnection(profile: com.nastechresearch.andcode.data.connection.ConnectionProfile)
