...
import com.nastechresearch.andcode.MainActivity
 ...
 * [com.nastechresearch.andcode.data.connection.SecureSettingsRepository.localRuntimeStoppedByUser].
 *
 ...
 * [com.nastechresearch.andcode.core.runtime.RuntimeWorkTracker]) is actually in flight. The
 ...
 * ([com.nastechresearch.andcode.feature.schedule.ScheduleExecutionService.ensureLocalRuntimeReady])
 ...
 * [com.nastechresearch.andcode.core.runtime.RuntimeWorkTracker] and therefore already fails
...
class LocalRuntimeService : Service() {
     ...
     * [com.nastechresearch.andcode.data.repository.RuntimeActivityRepository]. Claude Code and
    ...
    companion object {
        ...
        const val ACTION_INSTALL_AND_START = "com.nastechresearch.andcode.local.INSTALL_AND_START"
        const val ACTION_INSTALL_FULL_DEVELOPMENT_TOOLS = "com.nastechresearch.andcode.local.INSTALL_FULL_DEVELOPMENT_TOOLS"
        const val ACTION_START = "com.nastechresearch.andcode.local.START"
        const val ACTION_STOP = "com.nastechresearch.andcode.local.STOP"
        const val ACTION_RESTART = "com.nastechresearch.andcode.local.RESTART"
        const val ACTION_REINSTALL = "com.nastechresearch.andcode.local.REINSTALL"
        const val ACTION_UPDATE = "com.nastechresearch.andcode.local.UPDATE"
        const val ACTION_ROLLBACK = "com.nastechresearch.andcode.local.ROLLBACK"
        const val ACTION_DELETE = "com.nastechresearch.andcode.local.DELETE"

        /** Ids of the agents an install should provision; see [LocalRuntimeInstaller.install]. */
        const val EXTRA_AGENTS = "com.nastechresearch.andcode.local.AGENTS"
        const val EXTRA_FULL_DEVELOPMENT_TOOLS = "com.nastechresearch.andcode.local.FULL_DEVELOPMENT_TOOLS"
