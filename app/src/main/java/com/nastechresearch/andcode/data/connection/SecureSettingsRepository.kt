package com.nastechresearch.andcode.data.connection

import android.content.Context
import android.content.SharedPreferences
import androidx.security.crypto.EncryptedSharedPreferences
import androidx.security.crypto.MasterKey
import com.nastechresearch.andcode.data.repository.UnreadSessionStore
import com.nastechresearch.andcode.feature.wakeword.WakeWordGrammar
import com.nastechresearch.andcode.runtime.RuntimeConnectionStore
import com.nastechresearch.andcode.runtime.local.AdbConnectionStore
...
class SecureSettingsRepository(context: Context) : RuntimeConnectionStore, UnreadSessionStore, AdbConnectionStore {
    ...
    /** Which downloaded speech model listens, as a [com.nastechresearch.andcode.feature.wakeword.VoskModelLanguage] id. */
        ...
        set(value) {
            preferences.edit()
                .putString(
                    ...
                    com.nastechresearch.andcode.runtime.local.LocalProviderCredentialStore.encodeMap(value),
                )
                .apply()
        }

    fun providerApiKeys(): Map<String, String> =
        com.nastechresearch.andcode.runtime.local.LocalProviderCredentialStore.decodeMap(
    ...
    var customProviders: List<com.nastechresearch.andcode.runtime.local.CustomProviderDefinition>
        get() =
            com.nastechresearch.andcode.runtime.local.CustomProviderStore.decodeList(
        ...
        set(value) {
            preferences.edit()
                .putString(
                    ...
                    com.nastechresearch.andcode.runtime.local.CustomProviderStore.encodeList(value),
                )
                .apply()
        }
     ...
     * [com.nastechresearch.andcode.feature.workspace.WorkspaceViewModel.stopLocalRuntime] both reach
     ...
     * [com.nastechresearch.andcode.startup.shouldRestoreOnForegroundReturn] so a deliberate stop is not
    ...
    companion object {
         ...
         * uncaught here this crashed [com.nastechresearch.andcode.AndCodeApplication.onCreate] itself,
