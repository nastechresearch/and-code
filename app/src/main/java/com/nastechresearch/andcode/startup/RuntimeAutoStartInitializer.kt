...
import com.nastechresearch.andcode.hasUsableRuntimeSetup
 ...
 * [com.nastechresearch.andcode.AndCodeApplication]'s foreground observer, which only ever sees `true`
...
class RuntimeAutoStartInitializer : Initializer<RuntimeAutoStartInitializer.Result> {
    ...
    companion object {
        /**
         * Reconciles [com.nastechresearch.andcode.data.connection.SecureSettingsRepository.onboardingCompleted]
         ...
         * ([com.nastechresearch.andcode.AndCodeApplication.observeForegroundForRuntimeRestart]).
         *
         * The two callers no longer carry equal weight. While
         * [com.nastechresearch.andcode.data.connection.SecureSettingsRepository.localRuntimeIdleStopEnabled]
