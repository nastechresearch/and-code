package com.nastechresearch.andcode.core.notification
...
class RuntimeNotificationHelper(private val context: Context) {
    ...
    companion object {
        ...
        const val ACTION_PERMISSION_RESPONSE = "com.nastechresearch.andcode.PERMISSION_RESPONSE"
        ...
        /** The key [com.nastechresearch.andcode.MainActivity] reads to jump straight to a session. */
