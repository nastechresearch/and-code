package com.nastechresearch.andcode.core.lifecycle
 ...
 *
 * That includes the app's own cold start: [com.nastechresearch.andcode.AndCodeApplication]'s
 * foreground observer is the sole driver of
 * [com.nastechresearch.andcode.startup.RuntimeAutoStartTrigger.AppLaunch] now that
 * [com.nastechresearch.andcode.startup.RuntimeAutoStartInitializer.create] no longer restores the
