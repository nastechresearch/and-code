package com.nastechresearch.andcode.core.util
 ...
 *
 * Written for [com.nastechresearch.andcode.AndCodeApplication]'s `"sessions"` wake-lock lease, which
 * follows [com.nastechresearch.andcode.data.repository.RuntimeActivityRepository]'s
 * `activeSessionIds`: that set is cleared the instant the runtime target leaves
 * [com.nastechresearch.andcode.runtime.RuntimeState.Connected]/`Connecting`, including for a
