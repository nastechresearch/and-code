package com.nastechresearch.andcode.feature.onboarding
...
import com.nastechresearch.andcode.feature.settings.ProviderAuthDialog
import com.nastechresearch.andcode.feature.settings.SettingsUiState
...
fun AndroidSetupScreen(
    ...
    onSelectAntigravityPermissionMode: (com.nastechresearch.andcode.runtime.local.AntigravityPermissionMode) -> Unit = {},
...
private fun AntigravityInstallProgress(antigravity: AntigravityControllerState) {
    when (val install = antigravity.install) {
        is com.nastechresearch.andcode.runtime.local.AntigravityInstallStatus.Installing -> {
        ...
        is com.nastechresearch.andcode.runtime.local.AntigravityInstallStatus.Ready ->
        ...
        is com.nastechresearch.andcode.runtime.local.AntigravityInstallStatus.Failed ->
        ...
        com.nastechresearch.andcode.runtime.local.AntigravityInstallStatus.Idle ->
            if (antigravity.installed) {
                ...
                ReadyAgentRow(
                    stringResource(
                        ...
                        antigravity.version ?: com.nastechresearch.andcode.runtime.local.AntigravityManifest.VERSION,
                    ),
                )
            } else {
