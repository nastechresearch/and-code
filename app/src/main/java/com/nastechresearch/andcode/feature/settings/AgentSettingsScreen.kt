...
import com.nastechresearch.andcode.feature.workspace.ClaudeCodeCard
import com.nastechresearch.andcode.runtime.LocalAgent
import com.nastechresearch.andcode.runtime.LocalRuntimeStatus
import com.nastechresearch.andcode.runtime.local.AntigravityAuthCoordinator
import com.nastechresearch.andcode.runtime.local.AntigravityControllerState
import com.nastechresearch.andcode.runtime.local.AntigravityInstallStatus
import com.nastechresearch.andcode.runtime.local.ClaudeAuthCoordinator
import com.nastechresearch.andcode.runtime.local.ClaudeCodeUiState
import com.nastechresearch.andcode.runtime.local.ClaudeInstallStatus
import com.nastechresearch.andcode.runtime.local.ClaudePermissionMode
import com.nastechresearch.andcode.runtime.local.LocalRuntimeUpdateCheck
import com.nastechresearch.andcode.ui.components.RuntimeOperationResultCard
import com.nastechresearch.andcode.ui.components.RuntimeUpdateProgressCard
import com.nastechresearch.andcode.ui.components.SectionCard
import com.nastechresearch.andcode.ui.components.displayName
import com.nastechresearch.andcode.ui.components.formatRuntimeBytes
import com.nastechresearch.andcode.ui.components.systemPromptPresetLabel
import com.nastechresearch.andcode.ui.runtimeAgentIcon
...
fun AntigravityAgentSettingsScreen(
    ...
    onInstall: () -> Unit,
    onUpdate: () -> Unit,
    onSelectPermissionMode: (com.nastechresearch.andcode.runtime.local.AntigravityPermissionMode) -> Unit,
    onSignIn: () -> Unit,
    ...
    AgentSettingsScaffold(title = stringResource(LocalAgent.ANTIGRAVITY.displayNameRes), onBack = onBack) {
        AgentCardSection {
            AgentStatusCard(
                ...
                com.nastechresearch.andcode.feature.workspace.AntigravityCard(
