...
import com.nastechresearch.andcode.data.schedule.ScheduleRunStatus
...
class ScheduleExecutionService : Service() {
    ...
    /**
     * Holds a [com.nastechresearch.andcode.core.runtime.RuntimeWorkTracker] lease for the whole run.
     *
     * This path never touches [com.nastechresearch.andcode.data.repository.RuntimeActivityRepository]
