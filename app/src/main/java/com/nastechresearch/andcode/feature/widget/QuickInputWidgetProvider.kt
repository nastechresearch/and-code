package com.nastechresearch.andcode.feature.widget
...
class QuickInputWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_SEND = "com.nastechresearch.andcode.widget.SEND"
        const val ACTION_MIC = "com.nastechresearch.andcode.widget.MIC"
