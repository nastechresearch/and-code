package com.nastechresearch.andcode.ui.navigation
...
import com.nastechresearch.andcode.data.settings.AppPreferences
import com.nastechresearch.andcode.data.settings.AppPreferencesRepository
import com.nastechresearch.andcode.feature.assistant.TtsPreview
import com.nastechresearch.andcode.feature.settings.AgentSettingsScreen
import com.nastechresearch.andcode.feature.settings.AntigravityAgentSettingsScreen
import com.nastechresearch.andcode.feature.settings.ClaudeCodeAgentSettingsScreen
import com.nastechresearch.andcode.feature.settings.GitHubSettingsScreen
import com.nastechresearch.andcode.feature.settings.ModelVisibilityScreen
import com.nastechresearch.andcode.feature.settings.OpenCodeAgentSettingsScreen
import com.nastechresearch.andcode.feature.settings.OpenCodeAgentSettingsViewModel
import com.nastechresearch.andcode.feature.settings.ProviderSettingsScreen
import com.nastechresearch.andcode.feature.settings.SettingsScreenV2
import com.nastechresearch.andcode.feature.settings.SettingsViewModel
import com.nastechresearch.andcode.feature.settings.SystemPromptScreen
import com.nastechresearch.andcode.feature.settings.VoiceSettingsScreen
import com.nastechresearch.andcode.feature.support.GitHubSupportSheetHost
import com.nastechresearch.andcode.feature.wakeword.VoskModelState
...
import com.nastechresearch.andcode.ui.components.systemPromptPresetLabel
...
fun NavGraphBuilder.settingsNavGraph(
    ...
    runtimeTargets: () -> List<com.nastechresearch.andcode.runtime.RuntimeTarget>,
    workspaces: () -> List<com.nastechresearch.andcode.runtime.WorkspaceRef>,
    ...
    claude: () -> com.nastechresearch.andcode.runtime.local.ClaudeCodeUiState,
    claudeActions: ClaudeSettingsActions,
    antigravity: () -> com.nastechresearch.andcode.runtime.local.AntigravityControllerState,
    ...
    composable(ROUTE_SETTINGS_VOICE) {
        ...
        val androidTtsEngines =
            remember {
                com.nastechresearch.andcode.feature.assistant.TTSManager.availableAndroidEngines(context)
        ...
        val restartWakeWord = {
            if (settingsState.wakeWordEnabled) {
                val restarted =
                    com.nastechresearch.andcode.feature.wakeword.WakeWordService.start(
                        context,
                ...
                if (enabled) {
                    ...
                    if (!microphonePermission) {
                        ...
                        android.widget.Toast.makeText(
                            context,
                            com.nastechresearch.andcode.R.string.wake_word_requires_assistant,
                        ...
                        android.widget.Toast.makeText(
                            context,
                            com.nastechresearch.andcode.R.string.wake_word_model_required,
                            android.widget.Toast.LENGTH_LONG,
                        ).show()
                        ...
                        if (!started) {
                            ...
                            android.widget.Toast.makeText(
                                context,
                                com.nastechresearch.andcode.R.string.wake_word_start_failed,
                    ...
                    settingsViewModel.setWakeWordEnabled(false)
                    com.nastechresearch.andcode.feature.wakeword.WakeWordService.stop(context)
                }
            },
    ...
    composable(ROUTE_SETTINGS_AGENT_OPENCODE) {
        val app = context.applicationContext as com.nastechresearch.andcode.AndCodeApplication
        val openCodeViewModel: OpenCodeAgentSettingsViewModel =
            androidx.lifecycle.viewmodel.compose.viewModel(
                key = "settings-agent-opencode",
                factory =
                    com.nastechresearch.andcode.ui.ViewModelFactory {
    ...
    composable(ROUTE_SETTINGS_MCP) {
        com.nastechresearch.andcode.feature.settings.McpScreen(
            registry = runtimeRegistry,
            agent = com.nastechresearch.andcode.runtime.LocalAgent.OPEN_CODE,
            onOpenBrowser = { url ->
                UrlLauncher.openUrl(context, url)
            },
            onBack = { navController.popBackStack() },
    ...
    composable(ROUTE_SETTINGS_MCP_CLAUDE) {
        com.nastechresearch.andcode.feature.settings.McpScreen(
            registry = runtimeRegistry,
            agent = com.nastechresearch.andcode.runtime.LocalAgent.CLAUDE_CODE,
            onOpenBrowser = {},
            onBack = { navController.popBackStack() },
        )
    }
    ...
    composable(ROUTE_SETTINGS_MCP_ANTIGRAVITY) {
        com.nastechresearch.andcode.feature.settings.McpScreen(
            registry = runtimeRegistry,
            agent = com.nastechresearch.andcode.runtime.LocalAgent.ANTIGRAVITY,
            onOpenBrowser = {},
            onBack = { navController.popBackStack() },
        )
    }
    ...
    composable(ROUTE_SETTINGS_LEGAL) {
        com.nastechresearch.andcode.feature.settings.LegalScreen(
    ...
    composable(SETTINGS_LEGAL_DOCUMENT_ROUTE_PATTERN) { backStackEntry ->
        ...
        val document = com.nastechresearch.andcode.feature.settings.LegalDocument.fromId(docId)
        if (document != null) {
            com.nastechresearch.andcode.feature.settings.LegalDocumentScreen(
                document = document,
                onBack = { navController.popBackStack() },
            )
        }
...
data class ClaudeSettingsActions(
    val onInstall: () -> Unit,
    val onUpdate: () -> Unit,
    val onSelectPermissionMode: (com.nastechresearch.andcode.runtime.local.ClaudePermissionMode) -> Unit,
    val onSignIn: () -> Unit,
...
data class AntigravitySettingsActions(
    val onInstall: () -> Unit,
    val onUpdate: () -> Unit,
    val onSelectPermissionMode: (com.nastechresearch.andcode.runtime.local.AntigravityPermissionMode) -> Unit,
    val onSignIn: () -> Unit,
    val onSubmitCode: (String) -> Unit,
    val onCancelSignIn: () -> Unit,
    val onSignOut: () -> Unit,
