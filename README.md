...
[Releases](https://github.com/nastechresearch/and-code/releases/latest) · [日本語のREADME](README.ja.md)
...
1. Install the APK from [Releases](https://github.com/nastechresearch/and-code/releases/latest)
